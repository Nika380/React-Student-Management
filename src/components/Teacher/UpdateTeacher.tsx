...
function UpdateTeacher(props: any) {
    ...
    const updateTeacherInfo = (e: { preventDefault: () => void; }) => {
        const teacher = {
            firstName,
            lastName,
            email,
        ...
        fetch(`http://localhost:8080/teachers/${id}/update`, {
            method: 'PUT',
            headers: {
          ...
          .then(data => {
            ...
            alert(teacher.firstName + " " + teacher.lastName + " Info Updated")
          })
          .catch((error) => {
  ...
  return (
    ...
    <Stack spacing={6} direction='row' marginTop="20px" marginLeft="20%">
        <Button variant='contained' color='success' onClick={updateTeacherInfo}>Submit</Button>
